...
final class ListBodyCompositionMeasurementsRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('viewAny', BodyCompositionMeasurement::class) ?? false;
    }
    ...
    public function toDto(): ListBodyCompositionMeasurementsDTO
    {
        return new ListBodyCompositionMeasurementsDTO(
